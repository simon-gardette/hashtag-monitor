...
from app.blueprints.base.forms import LoginForm, CreateAccountForm
...
@blueprint.route("/all-links.html")
def all_links():
    links = []
    ...
    return render_template("dev-feature/all-links.html", links=links)
